...
export function isCompletedGame<T extends SchedulableGame>(
  game: T,
  todayKey: string,
) {
...
export function getPlgGamePresentation(
  game: ScheduleGame,
): GamePresentationMode {
  return typeof game.awayScore === "number" &&
    typeof game.homeScore === "number"
    ? "final"
    : "scheduled";
}
